...
// Testing with different fuel levels and engine temperatures.
...
if (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking"){
 ...
 // Trying few more if elses...
   else if(fuelLevel === 21000 && engineTemperature === 1200 && engineIndicatorLight === "NOT red blinking"){
        console.log("Full tank. Engines are good.");
   }
   else if(fuelLevel = 900){
    console.log("ENGINE FAILURE IMMINENT!");
   }
   else if(fuelLevel >= 12000 && engineTemperature >= 1200 && engineIndicatorLight === "NOT red blinking"){
...
if(commandOverride){
    ...
    console.log("Shuttle not ready to launch! Check if fuel and engine are ok.")
}
